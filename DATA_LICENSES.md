...
One DRACO-derived affiliate-marketing query was anonymized before public release to remove a named individual, a small-business identifier, and a private-planning-board reference. The row remains counted as DRACO-derived because the task structure and rubric source are retained, but the public text now describes a generic affiliate/referral strategy scenario.
