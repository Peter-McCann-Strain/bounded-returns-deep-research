...
DG = json.load(open(f"{ROOT}/papers/paper_a_bounded_returns/analysis/canonical_numbers.json"))["n_eff"]["diagnostics"]
C = DG["condorcet_null"]
...
plt.tight_layout()
for ext in ("pdf", "png"):
    plt.savefig(f"{ROOT}/papers/paper_a_bounded_returns/figures/fig_neff_condorcet.{ext}", dpi=200, bbox_inches="tight")
