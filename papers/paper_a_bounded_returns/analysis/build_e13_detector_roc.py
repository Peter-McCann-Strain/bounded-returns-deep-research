...
papers/paper_a_bounded_returns/analysis/. This builder uses the NEW path (unlike the
legacy builders that still hardcode papers/paper_a_bounded_returns/analysis and crash on
...
def main() -> int:
    ...
    _merge(cn.setdefault("e13_detector_roc", {}), out)
