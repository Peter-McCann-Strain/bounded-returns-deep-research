...
FR = json.load(open(f"{ROOT}/papers/paper_a_bounded_returns/analysis/canonical_numbers.json"))["variance_decomposition"]["flip_rates"]
...
plt.tight_layout()
for ext in ("pdf", "png"):
    plt.savefig(f"{ROOT}/papers/paper_a_bounded_returns/figures/fig_flip_rate.{ext}",
