...
# Run:  bash papers/paper_a_bounded_returns/analysis/rebuild_all.sh
set -e
cd "$(dirname "$0")/../../.."
source venv/bin/activate
A=papers/paper_a_bounded_returns/analysis
...
echo "[p3a] build_frozen_defence (repo-root analysis/, not $A)"; python analysis/build_frozen_defence.py >/dev/null
echo "[p3a-merge] frozen_defence";      python $A/merge_staging_key.py analysis/staging/frozen_defence.json frozen_defence
