...
Usage:
    python papers/paper_a_bounded_returns/analysis/build_routability_equivalence.py
    python papers/paper_a_bounded_returns/analysis/build_routability_equivalence.py --write
"""
import argparse
import json
import os
...
def main():
    ...
    _merge(cn.setdefault("routability", {}).setdefault("equivalence", {}), results)
    tmp = f"{CANON}.tmp"
