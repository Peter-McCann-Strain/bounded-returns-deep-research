...
e7 = json.load(open(f"{ROOT}/papers/paper_a_bounded_returns/analysis/canonical_numbers.json"))["e7_selector_kappa"]
...
plt.tight_layout()
for ext in ("pdf", "png"):
    plt.savefig(f"{ROOT}/papers/paper_a_bounded_returns/figures/fig_e7_selector_ladder.{ext}",
