...
p = json.load(open(f"{ROOT}/papers/paper_a_bounded_returns/analysis/canonical_numbers.json"))
_merge(p.setdefault("run_stability", {}), out)
json.dump(p, open(f"{ROOT}/papers/paper_a_bounded_returns/analysis/canonical_numbers.json", "w"), indent=1)
