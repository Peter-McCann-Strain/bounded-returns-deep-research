...
``papers/paper_a_bounded_returns/analysis/canonical_numbers.json`` (lines 58-60).  That tree was
MOVED to ``papers/paper_a_bounded_returns/analysis/`` by commit 0a80ba6, so the original
...
Usage:
    python papers/paper_a_bounded_returns/analysis/build_e4_cite_causal_v2.py --dry-run
    python papers/paper_a_bounded_returns/analysis/build_e4_cite_causal_v2.py
"""
...
# the dead papers/paper_a_bounded_returns path the original hardcodes.
ANA = _THIS_DIR
...
def main() -> int:
    ...
    _merge(canon.setdefault("e4_cite_causal", {}), block)
