...
R = json.load(open(f"{ROOT}/papers/paper_a_bounded_returns/analysis/canonical_numbers.json"))
...
axA.fill_between(xs, base - margin, base + margin, color=C_FACTUAL, alpha=0.08, zorder=1,
...
plt.tight_layout()
for ext in ("pdf", "png"):
    plt.savefig(f"{ROOT}/papers/paper_a_bounded_returns/figures/fig_e5_dose_response.{ext}",
