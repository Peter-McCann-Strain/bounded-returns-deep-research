...
Usage:
    python papers/paper_a_bounded_returns/analysis/build_contamination_decontaminated.py --help
    python papers/paper_a_bounded_returns/analysis/build_contamination_decontaminated.py
"""
