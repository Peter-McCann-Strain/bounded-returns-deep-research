...
Usage:
    ...
    python papers/paper_a_bounded_returns/analysis/build_contamination.py --dry-run     # plan only
    python papers/paper_a_bounded_returns/analysis/build_contamination.py               # provisional side-car
    python papers/paper_a_bounded_returns/analysis/build_contamination.py --finalize    # write canonical key (human, later)
"""
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    _merge(cn.setdefault("contamination", {}), result_block)
