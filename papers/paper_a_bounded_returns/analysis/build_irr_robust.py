...
Run:  ./venv/bin/python papers/paper_a_bounded_returns/analysis/build_irr_robust.py
Out:  updates papers/paper_a_bounded_returns/analysis/canonical_numbers.json
        -> ['irr']['robustness']
"""
import json
import warnings
