...
``papers/paper_a_bounded_returns/analysis/``. ``build_judge_vs_human.py`` (and
...
Usage:
    ...
    python papers/paper_a_bounded_returns/analysis/fix_canonical_path_ana.py --check

    # apply the fix in place (writes the .py, NOT the canonical json)
    python papers/paper_a_bounded_returns/analysis/fix_canonical_path_ana.py --apply
