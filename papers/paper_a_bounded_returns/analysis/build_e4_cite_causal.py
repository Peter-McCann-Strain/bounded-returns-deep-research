...
Usage:
    python papers/paper_a_bounded_returns/analysis/build_e4_cite_causal.py
    python papers/paper_a_bounded_returns/analysis/build_e4_cite_causal.py --dry-run   # CoT-mining
