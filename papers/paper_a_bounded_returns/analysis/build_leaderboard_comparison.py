...
Outputs (written ONLY under papers/paper_a_bounded_returns/analysis/, never the corpus):
...
Usage:
    python papers/paper_a_bounded_returns/analysis/build_leaderboard_comparison.py
    python papers/paper_a_bounded_returns/analysis/build_leaderboard_comparison.py --self-test
"""
