...
2. It scaffolds a NEW canonical key  oracle['rxu_decomposition']  that splits the factual
   ...
   script scripts/run_e14_oracle_entail.py (DEFAULT_MODEL gpt-4o, configured PTU deployment,
...
def build_rxu_decomposition() -> dict:
    ...
    out = {
        "_note": ("Claim-level factual decomposition P(correct)=P(R)xP(U|R). R = a source was "
                  ...
                  "configured PTU deployment, $0 marginal, NO Opus, NO 7B)."),
        "definition": {
    ...
    if os.path.exists(E14_PER_REPORT):
        ...
        out["oracle"]["_endpoint"] = "PTU gpt-4o (the configured PTU deployment), $0 marginal — NOT $0-local"
