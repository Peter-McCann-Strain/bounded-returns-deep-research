...
(``DEFAULT_MODEL=gpt-4o`` on PTU configured PTU deployment) as the existing
...
ANCHOR_TIER = "gpt-4o"  # == DEFAULT_MODEL on PTU the configured PTU deployment == the 248k corpus backbone
...
async def _amain() -> None:
    ...
    print(f"  Corpus anchor tier present: {ANCHOR_TIER in tiers} "
          f"(gpt-4o = DEFAULT_MODEL on PTU the configured PTU deployment, matches 248k corpus)")
