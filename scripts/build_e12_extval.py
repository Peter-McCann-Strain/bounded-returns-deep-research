...
replicate on a FRESH 600-report battery? Generation = GPT-4o (configured PTU deployment), judge = GPT-5.2 (independent). The battery is 5 query families x
...
def build():
    ...
    out = {
        "_note": (
            ...
            "generation GPT-4o (the configured PTU deployment), judge GPT-5.2 (independent). Folds the "
